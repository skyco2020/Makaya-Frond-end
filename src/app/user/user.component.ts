...
export class UserComponent implements OnInit {
  ...
  cityid = 0;
  Movies: any;
  constructor(private userService: SkycoService, private taskser: TaskService, private router: Router) { }
    ...
    this.Movies = [
      {
        ...
        description: 'The final part of Yasujiro Ozu’s loosely connected ‘Noriko’ trilogy is a devastating story of elderly grandparents brushed aside by their self-involved family.',
        picture: '../../assets/img/tokyo-story-1953.jpg'
      }, {
        name: 'TOUSSAINT LOUVERTURE',
        age: 'May 2013',
        description: 'Toussaint L’Ouverture Mini-Series, France. Rococopunk is – like Dieselpunk – a sibling of Steampunk, set in the earlier Renaissance era, primarily in the high-class French community of the time.',
        picture: '../../assets/img/TOUSSAINT_LOUVERTURE.jpg'
     }, {
        name: 'Heading South',
        age: 'Heading South 2005',
        description: 'Three female tourists have their eyes opened while visiting the poverty-stricken and dangerous world of 1980s Haiti.',
        picture: '../../assets/img/Heading_South.jpg'
     }, {
        name: 'Voodoo Possession',
        age: 'Voodoo Possession (2014)',
        description: 'For believers and skeptics alike, there is nothing in this world or the next to rival the relentless evil of a Voodoo Possession.',
        picture: '../../assets/img/Voodoo.jpg'
     },
     {
      name: ' Pluie d\'espoir',
      age: 'Jacque Roc 2005',
      description: 'Pluie d\'Espoir is a movie based on the story of a young peasant named Toussaint from the Haitian Provinces. His instinct for survival is strong.',
      picture: '../../assets/img/Pluie _d_espoir.jpg'
    }, {
      name: 'Lakay',
      age: 'Brian T. Lee 2009',
      description: 'A powerful and engaging social issue documentary investigating the living situations and treatment of Haitian immigrants and their children in the Bahamas.',
      picture: '../../assets/img/Lakay.jpg'
    }, {
      name: 'La Règle du jeu',
      age: 'Jean Renoir, France 1939',
      description: 'Made on the cusp of WWII, Jean Renoir’s satire of the upper-middle classes was banned as demoralising by the French government for two decades after its release.',
      picture: '../../assets/img/regle-du-jeu-la-1939.jpg'
    }, {
      name: 'The Searchers',
      age: 'John Ford, USA 1956',
      description: 'John Ford created perhaps the greatest of all westerns with this tale of a Civil War veteran doggedly hunting the Comanche who have kidnapped his niece.',
      ...
      description: 'Lured to Hollywood by producer William Fox, German Expressionist filmmaker F.W. Murnau created one of the silent cinema’s last and most luminous masterpieces.',
  ...
  OnSubmit(userName) {
    if (userName === '') {
      ...
      (err: HttpErrorResponse) => {
        ...
        else if (err.error.ErrorDescription === 'There is already an account with this email'){
          localStorage.setItem('IdUser', err.error.ErrorCode);
          localStorage.setItem('mail', userName);
          this.router.navigate(['/account']);
        }
